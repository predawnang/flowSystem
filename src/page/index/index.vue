							...
							<el-col :span="12">
								<div class="pay taxBgcolor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">120<span class="perTitle">( KB )</span></p>
									</div>
									<div class="rightItem">
							...
							<el-col :span="6">
								<div class="pay extenedBgcolor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">686 <span class="perTitle">( 单 )</span></p>
									</div>
									<div class="rightItem">
							...
							<el-col :span="6">
								<div class="pay likeBgcolor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">1276 <span class="perTitle">( 单 )</span></p>
									</div>
									<div class="rightItem">
							...
							<el-col :span="6">
								<div class="pay linkBgColor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">82367<span class="perTitle">( 台 )</span></p>
									</div>
									<div class="rightItem">
							...
							<el-col :span="6">
								<div class="pay keleBgColor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">827373<span class="perTitle">( 台 )</span></p>
									</div>
									<div class="rightItem">
